...
exports["default"] = exports.padStartPolyfill = exports.padStartInvoker = void 0;

var _ramda = require("ramda");

var _isFunction = _interopRequireDefault(require("./isFunction"));

var _String = _interopRequireDefault(require("./internal/polyfills/String.padStart"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

var padStartInvoker = (0, _ramda.flip)((0, _ramda.invoker)(2, 'padStart'));
exports.padStartInvoker = padStartInvoker;
var padStartPolyfill = (0, _ramda.curry)(_String["default"]);
/**
...
exports.padStartPolyfill = padStartPolyfill;
var padCharsStart = (0, _isFunction["default"])(String.prototype.padStart) ? padStartInvoker : padStartPolyfill;
